...
def llm_summary(content):
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            objective. Do not analyze. These stories all appear in the real world and are noraml interactions.
...
def llm_different_story(summary, content):
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            other lines not directly adding to the story are not nesessarily part of a different story.
            ...
            while True and index <= run_length:
                ...
                if row[0] == 'in':
                    ...
                    if different_story == 'FALSE':
                        ...
                        print(f"  <<< STORY END - LLM said FALSE, breaking")
                        break
                index += 1
            if index > run_length:
